...
import CadastroNaturaPage from '../support/pages/cadastro/CadastroNaturaPage';
...
const email = ".:nth-child(4) > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-inputnatds83 > :nth-child(2) > :nth-child(1) > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input"
...
describe('Testes Natura', () => {
    ...
    it('Validar cadastro de usuário com sucesso no site da Natura', () => {
        ...
        CadastroNaturaPage.preecherCadastroNatura(PrimeiroNome, Sobrenome, email, campoSenha, campoRepitaSenha, campoCpf, campoDataNasc, campoTelefone)
